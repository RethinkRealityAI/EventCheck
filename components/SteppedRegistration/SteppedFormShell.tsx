  ...
  return (
    <div className="flex-1 min-h-0 flex flex-col">
      ...
      <div className="flex-1 min-h-0 overflow-y-auto">
        <div className="flex flex-col lg:flex-row gap-4 lg:gap-8 px-4 md:px-6 pt-4 md:pt-5 pb-3">
          <aside className="lg:w-56 shrink-0 lg:sticky lg:top-0 lg:self-start">
            <StepperSidebar
              steps={steps}
      ...
      <div className="shrink-0 border-t border-gansid-outline-variant/20 bg-gansid-surface-container-lowest px-4 md:px-6 py-2.5 flex flex-col gap-1.5">
        ...
        <div className="flex flex-wrap justify-between items-center gap-2">
          <button
            ...
            className="px-4 py-1.5 rounded-full bg-white border border-gansid-outline-variant/40 text-gansid-on-surface text-sm font-display font-semibold disabled:opacity-40 disabled:cursor-not-allowed hover:bg-gansid-surface-container-low transition"
          >
            ← Previous
          </button>
          <div className="flex items-center gap-2 text-[11px] font-display text-gansid-on-surface/50 uppercase tracking-wider">
          ...
          <div className="flex items-center gap-2">
            {props.onSaveAndClose && (
              <button
                ...
                className="px-3 py-1.5 rounded-full bg-white border border-gansid-outline-variant/40 text-gansid-on-surface/70 font-display font-semibold text-xs hover:bg-gansid-surface-container-low transition"
            ...
            {isLastStep ? (
              <button
                ...
                className="px-5 py-1.5 rounded-full bg-gansid-primary-gradient text-white text-sm font-display font-bold shadow-lg hover:scale-[1.02] transition-all whitespace-nowrap"
              >
