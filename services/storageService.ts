...
export const getSettings = async (): Promise<AppSettings> => {
  ...
  const settings: AppSettings = {
    ...
    emailContactInviteSubject: (data as any).email_contact_invite_subject || DEFAULT_SETTINGS.emailContactInviteSubject,
    emailContactInviteBody: (data as any).email_contact_invite_body || DEFAULT_SETTINGS.emailContactInviteBody,
    ...
    emailBogoTicketSubject: (data as any).email_bogo_ticket_subject || '',
    emailBogoTicketBody: (data as any).email_bogo_ticket_body || '',
    emailBogoClaimLinkSubject: (data as any).email_bogo_claim_link_subject || '',
    emailBogoClaimLinkBody: (data as any).email_bogo_claim_link_body || '',
    emailBogoTicketUpdatedSubject: (data as any).email_bogo_ticket_updated_subject || '',
    emailBogoTicketUpdatedBody: (data as any).email_bogo_ticket_updated_body || '',
    emailBogoTicketWithdrawnSubject: (data as any).email_bogo_ticket_withdrawn_subject || '',
    emailBogoTicketWithdrawnBody: (data as any).email_bogo_ticket_withdrawn_body || '',
...
export const saveSettings = async (settings: AppSettings): Promise<void> => {
  const dbRecord = {
    ...
    email_contact_invite_subject: settings.emailContactInviteSubject ?? null,
    email_contact_invite_body: settings.emailContactInviteBody ?? null,
    ...
    email_bogo_ticket_subject: settings.emailBogoTicketSubject ?? null,
    email_bogo_ticket_body: settings.emailBogoTicketBody ?? null,
    email_bogo_claim_link_subject: settings.emailBogoClaimLinkSubject ?? null,
    email_bogo_claim_link_body: settings.emailBogoClaimLinkBody ?? null,
    email_bogo_ticket_updated_subject: settings.emailBogoTicketUpdatedSubject ?? null,
    email_bogo_ticket_updated_body: settings.emailBogoTicketUpdatedBody ?? null,
    email_bogo_ticket_withdrawn_subject: settings.emailBogoTicketWithdrawnSubject ?? null,
    email_bogo_ticket_withdrawn_body: settings.emailBogoTicketWithdrawnBody ?? null,
